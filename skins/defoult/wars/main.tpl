...
<div class="game-main">
    ...
    <form class="game-kick-panel" action="" method="POST">
        ...
        <div class="game-input-block">
            <div><label class="game-input"><input type="radio" name="kick" value="1" class="game-input-barrier">Голова</label></div>
            <div><label class="game-input"><input type="radio" name="kick" value="2" class="game-input-barrier">Тело</label></div>
            <div><label class="game-input"><input type="radio" name="kick" value="3" class="game-input-barrier">Ноги</label></div>
        </div>
